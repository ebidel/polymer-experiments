...
Polymer.Annotations = {
  ...
  _parseNodeAnnotations: function _parseNodeAnnotations(node, list, stripWhiteSpace) {
    return node.nodeType === Node.TEXT_NODE ? this._parseTextNodeAnnotation(node, list) :
...
Polymer.Base._addFeature({
  ...
  _configureAnnotationReferences: function _configureAnnotationReferences(config) {
...
Polymer.Bind = {
  ...
  _notedListenerFactory: function _notedListenerFactory(property, path, isStructured) {
...
Polymer.StyleDefaults = (function () {
  ...
  var api = Object.defineProperties({
    ...
    */
    ...
    _styleProperties: { // NOTE: this object can be used as a styling scope so it has an api
...
(function () {
  ...
  Polymer({
    ...
    _apply: function _apply(deferProperties) {
      // used applied element from HTMLImports polyfill or this
      var e = this.__appliedElement || this;
      if (this.include) {
